...
public final class JavaLogQuery {
    ...
    public static final List<String> EXAMPLEA_PACHE_LOGS = Lists.newArrayList(
    ...
    public static final Pattern APACHE_LOG_REGEX = Pattern.compile(
    ...
    public static Tuple3<String, String, String> extractKey(String line) {
        Matcher m = APACHE_LOG_REGEX.matcher(line);
        if (m.find()) {
            String ip = m.group(1);
    ...
    public static void main(String[] args) {
        ...
        JavaRDD<String> dataSet = (args.length == 1) ? jsc.textFile(args[0]) : jsc.parallelize(EXAMPLEA_PACHE_LOGS);
